import { b as createAstro, c as createComponent, d as addAttribute, h as renderScript, a as renderTemplate, m as maybeRenderHead, r as renderComponent, s as spreadAttributes, u as unescapeHTML, g as renderHead, f as renderSlot, e as renderTransition } from './astro/server_BdfX4GWh.mjs';
import 'kleur/colors';
/* empty css                         */
import 'clsx';
...
import { $ as $$Image } from './_astro_assets_B8CH9-Az.mjs';
...
const $$Footer = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<div class="lg:border-secondary-white mx-auto hidden w-full py-2 lg:block lg:border-t-[0.5px]"> <small class="text-secondary-white block text-center">&copy; ${(/* @__PURE__ */ new Date()).getFullYear()} MJ Codes</small> </div>`;
...
const $$Navbar = createComponent(($$result, $$props, $$slots) => {
  ...
  const mjcodesLogo = "/icon.png";
  const currentPath = Astro2.url.pathname;
  return renderTemplate`${maybeRenderHead()}<nav class="bg-background-light/50 dark:bg-background-dark/50 lg:bg-background-white dark:lg:bg-background-dark border-primary fixed bottom-0 left-0 z-[1000] w-full flex-1 overflow-hidden border-t-[0.5px] text-black backdrop-blur-xl lg:h-screen lg:min-h-screen lg:w-[12vw] lg:border-t-0 lg:border-r-[0.5px] lg:backdrop-blur-none dark:text-white"> <div class="flex h-full flex-col items-center justify-between"> <!-- Logo --> <!-- TODO: Create an interactive area/playground for the logo --> <a href="/" title="Maxwell Kapezi Jr 🚀" class="group dark:bg-secondary-dark bg-se-light hidden w-full flex-col items-center justify-center py-4 lg:flex"> ${renderComponent($$result, "Image", $$Image, { "src": mjcodesLogo, "alt": "MJ Codes logo", "width": 40, "height": 40, "loading": "eager", "class": "group-hover-translate-x-4 h-10 w-10 animate-pulse transition-all duration-400 group-hover:-translate-y-2 hover:animate-bounce" })} <!-- <small
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  } })}${renderComponent($$result, "ClientRouter", $$ClientRouter, {})}${renderHead()}</head> <body class="from-background-light via-background-light to-secondary-light dark:from-background-dark dark:via-background-dark dark:to-secondary-dark relative flex min-h-screen min-w-screen flex-col overflow-x-hidden bg-gradient-to-br text-black antialiased lg:flex-row dark:text-white"> ${renderComponent($$result, "Navbar", $$Navbar, {})} <a href="/" class="absolute top-4 left-4 h-10 w-10 animate-pulse transition-all duration-400 lg:hidden"> <img src="/icon.png" alt="MJ Codes logo" width="40" height="40" loading="lazy"> </a> <div class="fixed right-[5%] bottom-[15vh] z-50 lg:top-4 lg:right-auto lg:bottom-auto lg:left-[12vw]"> <div class="flex flex-col items-center justify-center gap-5"> <div${addAttribute(`lg:hidden ${currentPath.startsWith("/blog/") ? "block" : "hidden"}`, "class")}> ${renderComponent($$result, "FontSettingsButtons", FontSettingsButtons, { "client:load": true, "client:component-hydration": "load", "client:component-path": "@/components/settings/FontSettingsButtons", "client:component-export": "default" })} </div> ${renderComponent($$result, "ThemeToggler", ThemeToggler, { "client:load": true, "client:component-hydration": "load", "client:component-path": "@/components/navigation/ThemeToggler", "client:component-export": "default" })} </div> </div> <main class="z-auto mx-auto w-full max-w-screen-xl px-4 lg:m-10 lg:mx-auto lg:w-[85vw] lg:px-[15vw] xl:w-[95vw] 2xl:w-full 2xl:max-w-screen-2xl"> ${renderSlot($$result, $$slots["default"])} </main> </body></html>`;
