...
import { b as createAstro, c as createComponent, m as maybeRenderHead, s as spreadAttributes, f as renderSlot, a as renderTemplate, r as renderComponent, d as addAttribute } from '../../chunks/astro/server_lUFmIoAw.mjs';
import 'kleur/colors';
import '@astrojs/internal-helpers/path';
import '@astrojs/internal-helpers/remote';
import { $ as $$Image } from '../../chunks/_astro_assets_BQvMC574.mjs';
import { $ as $$Flex } from '../../chunks/Flex_BTSBLKOr.mjs';
import { u as urlForImage, $ as $$Pill, a as $$FormattedDate, b as $$EstimatedTimeToRead } from '../../chunks/urlForImage_BQUT5nh2.mjs';
...
const $$slug = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": post.title, "description": post.description, "siteUrl": `https://bymjcodes.com/blog/${post.slug.current}`, "image": urlForImage(post.mainImage.asset), "type": "article" }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<article class="relative w-full"> <div class="relative m-auto max-w-lg pt-36 pb-64 lg:mx-auto lg:w-[85vw] lg:pt-28 lg:pb-28"> ${renderComponent($$result2, "Image", $$Image, { "src": urlForImage(post.mainImage.asset), "alt": post.mainImage.alt, "width": 500, "height": 500, "loading": "lazy", "class": "my-4 w-full shadow-lg" })} <div class="flex w-full flex-wrap items-center justify-end gap-2"> ${post.categories && post.categories.map((category) => renderTemplate`${renderComponent($$result2, "Pill", $$Pill, { "text": category.title, "variant": "tertiary" })}`)} </div> <div class="hidden lg:block"> ${renderComponent($$result2, "FontSettingsButtons", FontSettingsButtons, { "client:load": true, "client:component-hydration": "load", "client:component-path": "@/components/settings/FontSettingsButtons", "client:component-export": "default" })} </div> <!-- TODO: Make this stick on scroll rather than fixed --> <div class="dark:bg-background-dark/50 bg-background-light/50 fixed top-0 left-0 z-10 mx-auto w-full p-2 shadow-md backdrop-blur-xl lg:left-1/2 lg:w-1/2 lg:-translate-x-1/2 lg:shadow-none"> <div class="flex items-center gap-4"> <a href="/blog"> ${renderComponent($$result2, "Icon", $$Icon, { "name": "material-symbols-light:arrow-left-alt-rounded", "size": 40, "class": "text-primary transition-all duration-400 hover:translate-x-3 hover:text-black dark:hover:text-white" })} </a> <div class="w-full"> ${renderComponent($$result2, "Heading", $$Heading, { "text": post.title, "size": "md", "color": "text-primary", "className": "block w-[85%] overflow-hidden text-nowrap text-ellipsis whitespace-nowrap lg:w-full" })} <div class="pr-14 lg:pr-0"> ${renderComponent($$result2, "Flex", $$Flex, { "direction": "row", "justify": "between", "align": "center" }, { "default": async ($$result3) => renderTemplate` ${renderComponent($$result3, "FormattedDate", $$FormattedDate, { "unformattedDate": post.publishedAt })} ${renderComponent($$result3, "EstimatedTimeToRead", $$EstimatedTimeToRead, { "body": post.body })} ` })} </div> </div> </div> </div> <br> <div class="portable-text-body"> ${renderComponent($$result2, "PortableText", $$PortableText, { "portableText": post.body })} </div> </div> </article> ` })} `;
