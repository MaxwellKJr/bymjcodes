import { b as createAstro, c as createComponent, m as maybeRenderHead, a as renderTemplate, d as addAttribute } from './astro/server_lUFmIoAw.mjs';
import 'kleur/colors';
import 'clsx';
...
const $$EstimatedTimeToRead = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<small class="text-secondary-white my-1 text-sm">${readingTime}</small>`;
